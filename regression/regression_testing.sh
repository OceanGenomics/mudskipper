...
# mudskipper
echo mudskipper
$CARGO_BIN_EXE_mudskipper mudskipper bulk --gtf /biodb/human/gencode/v35/gene_annotations.gtf --alignment ./STAR_output/Aligned.out.sam --out transcriptomic.bam
