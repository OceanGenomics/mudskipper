...
impl BAMQueryRecordReader {
    ...
    // checks for equality in the target ID (tid), position (pos), reverse flag, and CIGAR string.
    ...
    // groups the records based on their alignment type and their matching supplementary alignments, while also handling skipped queries.
